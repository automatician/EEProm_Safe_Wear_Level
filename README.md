...
| :--- | :--- |
|The complete manual for using all public functions, parameters,<br and return values ​​can be found in the dedicated [API Manual)](MANUAL.md).|Starts directly with detailed example codes that will get you to your goal quickly. <br> * [Demo1: String in an array](Examples/demo1_type_char_array.ino)<br> * [Demo2: Store pure states or measured values ​​(numbers, Booleans)](Examples/demo2_type_int.ino)<br> * [Demo3: Store logical grouping of different but related data in structures](Examples/demo3_type_struct.ino)|
## **WHAT IT IS**
